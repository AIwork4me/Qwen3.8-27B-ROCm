...
| [`benchmark.md`](benchmark.md) | Generated result tables (quickstart mapping, both paths + both llama.cpp backends, MTP effect, context capacity, rule application) | Generated from the cells by `gen-verdicts.py` + `render-readme-blocks.py`; verdicts reviewed `controller-2026-08-17` (20 cells, frozen) + `controller-2026-08-18` (8 v0.1.2 cells) — 8 recommended / 14 caution / 6 avoid |
