...
| [dflash-pairing-2026-08-21](dflash-pairing-2026-08-21/) | 2026-08-21, UTC | the v0.1.9 DFlash2 pairing: {base,mtp} @131072 re-run cells (6 boots total incl. the dflash corpus boot) — the with-vs-without-DFlash2 same-session basis | runner with `CELLS_DIR=<this session dir>` (matrix untouched); dflash cells in `../cells/` |
