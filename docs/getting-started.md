...
DFlash2 variant (v0.1.9 — block-diffusion speculative decoding; 10.2 tok/s
...
```bash
SET=dflash2 bash scripts/02-fetch-model.sh  # ~3.6 GiB draft, SHA256-verified (models/Qwen3.8-27B-DFlash2)
