    ...
    if verdict == "avoid" and not m["anchor_ok"] and m["boot_ok"] and not m["failed_streams"]:
        ...
        if parts["c"] == 1:
            reason = (
                ...
                f"floor', not stably above it — a pre-registered "
                f"2026-08-22 daily series (README roadmap: \u22655 sessions, "
                f"median \u2265 10.0 in \u22655-of-5 with clean anchors "
                f"upgrades the wording; the mapping does not change under "
                f"any outcome) governs the eventual ruling. "
